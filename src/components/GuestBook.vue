          ...
          <div class="comment-info">
            <span class="comment-author">
              ...
              <div class="verified-container">
                <img v-if="message.verified" src="/src/assets/img/verified.png" height="22" width="22" alt="Verified" class="verified-icon">
...
export default {
  ...
  methods: {
    ...
    isAdmin(email) {
      return email = ["itxtahseen@gmail.com", "abuzahinmohammadnowsin@gmail.com"];
    },
    isModerator(email) {
